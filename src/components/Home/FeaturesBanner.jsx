            ...
            <Container>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6 p-6 '>
                    ...
                    <div className="content">
                        <h2 className='max-w-[507px] text-[35px] text-[#151875] font-josefin font-bold leading-relaxed'>Unique Features Of leatest &
                            Trending Poducts</h2>
                        ...
                        <div className='flex gap-5 items-center mt-[38px]'>
                            <button className='capitalize bg-[#FB2E86] text-white text-[17px] font-semibold py-[14px] px-6'>add to cart</button>
                            <div>
